...
public class OkExchangeTest {
    ...
    public static void main(String[] args) throws Exception {
        OkExchange huoBiExchange = new OkExchange();

        List<SymbolPair> list = huoBiExchange.getAllSymbolPairs();
        
        for(SymbolPair sy : list) {
        	
           BigOneTicker huOneTicker = huoBiExchange.getTicker(sy);
           System.out.println(sy.getMarketId() +huOneTicker);
        }
