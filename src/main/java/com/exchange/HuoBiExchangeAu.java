...
import com.huobi.api.au.ApiClient;
...
public class HuoBiExchangeAu extends Exchange {
    private List<SymbolPair> symbolPairs;
    ApiClient apiClient = new ApiClient(ApiFactory.getKey("HBAU").getApiKey(),
            ApiFactory.getKey("HBAU").getSecret());
    @Override
